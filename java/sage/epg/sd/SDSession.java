...
public abstract class SDSession
{
  ...
  public synchronized void authenticate() throws IOException, SDException
  {
    ...
    {
      if(Sage.DBG && debugEnabled()) System.out.println("SDSession/authenticate: using existing token:" + token + " with expiry:" + tokenExpiration + " expires in:" + ((tokenExpiration - (System.currentTimeMillis()/1000))/60) + " mins");
      return;
    }
